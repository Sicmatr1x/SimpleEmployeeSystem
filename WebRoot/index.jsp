...
<body>
	<section class="page-header">
		...
		<h2 class="project-tagline">This is a simple employee salary management system powered by SSM framework.</h2>
	...
	<section class="main-content">
		...
		<p><img src="<%=basePath%>resources/images/ER.png" alt="ER图"></p>
...
begin
    ...
    where empid = new.empid and mounth=old.attendDate;
		...
		<footer class="site-footer">
			<span class="site-footer-credits">This page was powered by <a
				href="https://github.com/pages-themes/cayman">cayman</a>.
			</span>
		</footer>
	</section>
